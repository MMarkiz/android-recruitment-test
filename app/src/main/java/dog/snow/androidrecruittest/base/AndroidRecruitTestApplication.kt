...
import dog.snow.androidrecruittest.ui.MainViewModelFactory
...
class AndroidRecruitTestApplication : Application(), KodeinAware {
    ...
    companion object {
        var instance: AndroidRecruitTestApplication? = null

        fun getContext(): Context {
            if (instance == null) {
                instance = AndroidRecruitTestApplication()
            }
    ...
    override val kodein = Kodein.lazy {
        ...
        bind<AndroidRecruitTestRepository>() with singleton { AndroidRecruitTestRepositoryImpl(instance(), instance(), instance()) }
